...
class Edge():
    ...
    def __init__(self, id, cids, shared_layers, ccmab):
        """
        id: edge id
        ...
        :param ccmab: CCMAB Object (the COCS Algorithm)
        :return:
        """
        self.id = id
        self.cids = cids
    ...
    def initial_CCMAB(self, num_rounds, es_id, context_dim):
        self.CCMAB = CCMAB(numer_rounds=num_rounds, id=es_id, num_context_features=context_dim)
